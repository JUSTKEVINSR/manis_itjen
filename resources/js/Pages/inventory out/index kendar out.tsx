...
export default function InventoryKendaraanOut({ inventoryKendaraanOuts, inventories, staffs }: { inventoryKendaraanOuts: any[], inventories: any[], staffs: any[] }) {
    ...
    const [selectedInventoryKendaraanOut, setSelectedInventoryKendaraanOut] = useState<any>(null);
    ...
    const addInventoryKendaraanOut: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('inventory-kendaraan-out.store'), {
            onSuccess: () => {
    ...
    const editInventoryKendaraanOut: FormEventHandler = (e) => {
        e.preventDefault();
        patch(route('inventory-kendaraan-out.update', selectedInventoryKendaraanOut.id), {
            onSuccess: () => {
    ...
    const deleteInventoryKendaraanOut: FormEventHandler = (e) => {
        e.preventDefault();
        destroy(route('inventory-kendaraan-out.destroy', selectedInventoryKendaraanOut.id), {
            onSuccess: () => {
    ...
    const openEditModal = (io: any) => {
        setSelectedInventoryKendaraanOut(io);
        setData({
    ...
    const handleFileUpload = (id: number, file: File | undefined) => {
        ...
        router.post(route('inventory-kendaraan-out.upload-surat', id), {
            _method: 'post',
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800">
                    Inventory Out Kendaraan
                </h2>
            }
        >
            <Head title="Inventory Kendaraan" />
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
                                    ...
                                    <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                                        {inventoryKendaraanOuts.map((io, index) => (
                                            <tr key={io.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4">
                                                    <a 
                                                        href={route('inventory-kendaraan-out.download-raw', io.id)} 
                                        ...
                                        {inventoryKendaraanOuts.length === 0 && (
                                            <tr>
...
*/}
            ...
            <Modal show={confirmingEdition} onClose={closeModal}>
                <form onSubmit={editInventoryKendaraanOut} className="p-6">
                    <h2 className="text-lg font-medium text-gray-900">
            ...
            <Modal show={confirmingDeletion} onClose={closeModal}>
                <form onSubmit={deleteInventoryKendaraanOut} className="p-6">
                    <h2 className="text-lg font-medium text-gray-900">
